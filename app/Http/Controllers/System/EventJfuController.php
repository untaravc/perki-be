            ...
            [
                ...
                "children"   => [
                    ...
                    [
                        ...
                        "date_end"   => "2025-05-29 12:00:00",
                        "children"   => [
                            [
                                "name"       => "Session 1",
                                "title"      => "Endovascular Intervention & Pharmacotherapy in Managing Foot Ulcer",
                                "data_type"  => "schedule-detail",
                                "section"    => "jfu25",
                    ...
                    [
                        ...
                        "date_start" => "2025-05-29 13:00:00",
                        "date_end"   => "2025-05-29 15:00:00",
                        "children"   => [
                            [
                                "name"       => "Session 1",
                                "title"      => "Diagnosis of Peripheral Arterial Disease",
                                "data_type"  => "schedule-detail",
                                "section"    => "jfu25",
                                "speakers"   => "taufik.ismail",
                                ...
                                "date_start" => "2025-05-29 13:00:00",
                                "date_end"   => "2025-05-29 13:30:00",
                            ],
                            [
                                "name"       => "Session 1",
                                "title"      => "Basic Hands on: Doppler Ultrasound in Diagnosing Peripheral Arterial Disease",
                                "data_type"  => "schedule-detail",
                                "section"    => "jfu25",
                                "speakers"   => "",
                                "marker"     => "symposium-jfu25-a3",
                                "slug"       => "symposium-jfu25-a3-2",
                                "date_start" => "2025-05-29 13:30:00",
                                "date_end"   => "2025-05-29 15:00:00",
                            ],
                        ]
                    ]
        ...
        return [
            [
                ...
                "children"   => [
                    ...
                    [
                        "name"       => "Advanced Hands on",
                        "title"      => "Advanced Hands on: Lower Extremities Arterial Disease, Carotids, Renal, AV Shunt, Chronic Venous Insufficiency, Deep Vein Thrombosis, Transcranial Doppler",
                        "data_type"  => "schedule",
                        "section"    => "jfu25",
                        "speakers"   => "",
                        "marker"     => "workshop-jfu25-1",
