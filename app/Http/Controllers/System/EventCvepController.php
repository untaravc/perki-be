...
class EventCvepController extends Controller
{
    ...
    private function workshop()
    {
        $ws_price = [
            ...
            ["job_type_code" => "DRGN", "price" => 250000,],
        ];

        return [
            [
                "name"       => "CPET for Specialist",
                "title"      => "",
                "subtitle"   => "",
                "data_type"  => "product",
                "section"    => "carvep",
                ...
                "date_start" => "2025-02-25 08:00:00",
                "date_end"   => "2025-02-25 12:00:00",
                "children"   => [
                    [
